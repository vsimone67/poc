...
using Hub.Service.Persistence.Context;
...
namespace Hub.Service.Extensions
{
    public static class DiExtensions
    {
        public static IServiceCollection ConfigureDiEnvironment(this IServiceCollection services, IConfiguration Configuration)
        {
            ...
            //services.AddDbContext<DBContext>(options => options.UseSqlServer(Configuration.GetConnectionString("Hub.Service"), providerOptions => providerOptions.CommandTimeout(120)));
